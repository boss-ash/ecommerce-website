...
CREATE TABLE `tbl_settings` (
  ...
  `home_service_on_off` int(1) NOT NULL,
  `home_welcome_on_off` int(1) NOT NULL,
  `home_featured_product_on_off` int(1) NOT NULL,
  `home_latest_product_on_off` int(1) NOT NULL,
  `home_popular_product_on_off` int(1) NOT NULL,
  `home_testimonial_on_off` int(1) NOT NULL,
  `home_blog_on_off` int(1) NOT NULL,
  `newsletter_on_off` int(1) NOT NULL,
